...
def viewpatientdata(request):
    return render(request, 'viewpatientdata.html')  # Ensure you have this template

def viewcsvdata(request):
    return render(request, 'viewcsvdata.html')  # Ensure you have this template